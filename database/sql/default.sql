INSERT INTO `laraton_options` (`id`, `option_key`, `option_value`, `is_sistem`) VALUES
...
INSERT INTO `laraton_users` (`id`, `name`, `username`, `email`, `email_verified_at`, `password`, `user_group_id`, `status`, `avatar`, `remember_token`, `last_login`, `created_at`, `updated_at`, `isDeleted`) VALUES
...
INSERT INTO `laraton_user_groups` (`id`, `group_name`, `group_value`) VALUES
